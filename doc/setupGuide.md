...
* Iromlab was created to be used in conjuction with Acronova Nimbie disc autoloaders. It has been tested with the [Nimbie NB21-DVD model](http://www.acronova.com/product/auto-blu-ray-duplicator-publisher-ripper-nimbie-usb-nb21/9/review.html). Support for [Vinpower CRONUS 220‐S2T‐NP‐BK CD Robot](https://www.vinpowerdigital.com/products/cronus220-s2t-np-bk-series) has been tested and added (currently it only supports using a single drive). It may work with other models supported by drivers provided by dBpoweramp Batch Ripper as well. It may work with other models as well.

Getting Iromlab up running requires a number of installation and configuration steps:

1. Install the device driver for the disc robot
1. Install Isobuster
...
**Cronus Users:** the Vinpower Cronus is an all-in-one machine and shouldn't require any setup.
